...
function Contact() {
  ...
  function sendMessage(event) {
    ...
    emailjs.send('service_795e8y3' , 'template_ibhw1e9',  {
      user_name: name,
      user_email: email,
      user_subject: subject,
      user_message: message
    }, '8QHScFpSmHReXvlkm').then(result => {
  ...
  return (
    <>
      <div
        name="contact"
        className="lg:h-screen lg:pt-[90px] md:pt-[250px] sm:pt-[250px] pt-[150px] lg:px-20 px-4 flex items-center justify-center bg-gray-200"
      >
          ...
          <div className="contact__mail">
            ...
            >
              <div className="grid grid-col-1 gap-6">
                ...
                <button
                  type="submit"
                  className="capitalize bg-orange-500 px-4 py-2 text-white flex items-center justify-center gap-1 text-center rounded-sm text-base"
                >
