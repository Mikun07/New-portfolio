          ...
          <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-6">
              ...
              <div className="relative overflow-hidden group">
                ...
                <div className=" absolute w-full h-full bg-black/20 flex items-center justify-center -bottom-10 group-hover:bottom-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <button className="cursor-pointer text-orange-500 bg-transparent w-[50px] h-[50px] border-2 border-orange-500 rounded-full">
                    <a target="_blank" href="https://github.com/Mikun07/Movie-Recommendation-App/tree/master">
            ...
            <article className="px-6 py-4 flex flex-col gap-4 bg-white rounded-lg">
              <div className="relative overflow-hidden group">
                ...
                <div className=" absolute w-full h-full bg-black/20 flex items-center justify-center -bottom-10 group-hover:bottom-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <button className="cursor-pointer text-orange-500 bg-transparent w-[50px] h-[50px] border-2 border-orange-500 rounded-full">
                    <a target="_blank" href="https://github.com/Mikun07/New-portfolio">
                      <ion-icon name="logo-github" size="large"></ion-icon>
                    </a>
                  </button>
                </div>
              ...
              <div className="px-2">
                ...
                <p className=" text-justify font-normal">
                  This portfolio is a beautifully designed, modern, and
                  responsive website built using ReactJS and Tailwind CSS.
                </p>
              </div>
            </article>
            ...
            <article className="px-6 py-4 flex flex-col gap-4 bg-white rounded-lg">
              <div className="relative overflow-hidden group">
                ...
                <div className=" absolute w-full h-full bg-black/20 flex items-center justify-center -bottom-10 group-hover:bottom-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <button className="cursor-pointer text-orange-500 bg-transparent w-[50px] h-[50px] border-2 border-orange-500 rounded-full">
                    <a target="_blank" href="https://mimabooking.netlify.app/">
                      <ion-icon name="logo-github" size="large"></ion-icon>
                    </a>
                  </button>
                </div>
              ...
              <div className="px-2">
                <h2 className=" capitalize font-bold">Website</h2>
                <h3 className="capitalize font-medium">
                  Hotel Booking Dasboard.
                </h3>

                <p className=" text-justify font-normal">
                  This is a beautifully designed hotel booking dashboard built
