...
function Home() {
  const Social = [
    {
      ...
      style:
        "bg-[#0077b5] h-[40px] w-[40px] md:h-[42px] md:w-[42px] lg:h-[45px] lg:w-[45px]  rounded-full text-xs md:text-lg sm:text-lg flex items-center text-white justify-center cursor-pointer hover:scale-105 duration-200",
    },
    {
      id: 2,
      icon: "logo-github",
      ...
      style:
        "bg-black h-[40px] w-[40px] md:h-[42px] md:w-[42px] lg:h-[45px] lg:w-[45px]  rounded-full text-xs md:text-lg sm:text-lg flex items-center text-white justify-center cursor-pointer hover:scale-105 duration-200",
    },
    {
      id: 3,
      icon: "mail-outline",
      ...
      style:
        "bg-[#EA4335] h-[40px] w-[40px] md:h-[42px] md:w-[42px] lg:h-[45px] lg:w-[45px] rounded-full text-xs md:text-lg sm:text-lg flex items-center text-white justify-center cursor-pointer hover:scale-105 duration-200",
    },
    {
      id: 4,
      ...
      href: "Resume",
      style:
        "bg-[#DD1908] h-[40px] w-[40px] md:h-[42px] md:w-[42px] lg:h-[45px] lg:w-[45px]  rounded-full text-xs md:text-lg sm:text-lg flex items-center text-white justify-center cursor-pointer hover:scale-105 duration-200",
      download: true,
      src: "Resume",
    },
    // {
  ...
  return (
    <>
      <div name="home" className="h-screen lg:pt-0 md:pt-[100px] sm:pt-[90px] pt-[150px] px-4 flex items-center bg-gray-200">
